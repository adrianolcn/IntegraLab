      ...
      <div className="max-w-md w-full glass-panel-elevated p-8 rounded-xl shadow-lg">
        ...
        <form className="mt-8 space-y-6" onSubmit={handleSubmit}>
          ...
          <div className="text-sm text-center">
             <span className="text-textMuted">{t('auth.no_account')} </span>
             <Link to="/register" className="font-medium text-blue-600 hover:text-blue-500 dark:text-primary-400 dark:hover:text-primary-300 transition-colors">
               {t('auth.register_btn')}
             </Link>
          </div>
        </form>
